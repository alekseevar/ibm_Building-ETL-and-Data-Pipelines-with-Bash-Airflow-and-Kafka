...
extract_data_from_tsv = BashOperator(
    ...
    bash_command="echo \"$(cut -d$'\t' -f4,5 /home/project/airflow/dags/finalassignment/tollplaza-data.tsv)\" | tr '\t' ',' > /home/project/airflow/dags/finalassignment/tsv_data.csv",
    dag=dag,
)

extract_data_from_fixed_width = BashOperator(
    task_id='extract_data_from_fixed_width',
    bash_command="echo \"$(cut -c59-61,62-67 /home/project/airflow/dags/finalassignment/payment-data.txt)\" | tr ' ' ',' >  /home/project/airflow/dags/finalassignment/fixed_width_data.csv",
    dag=dag,
)
...
transform_data = BashOperator(
    ...
    bash_command="sed -E 's/^(([^,]+,){3})([^,]+)/\1\\U\3/' /home/project/airflow/dags/finalassignment/extracted_data.csv > /home/project/airflow/dags/finalassignment/staging/transformed_data.csv",
    dag=dag,
)
